...
from constants.gui_constants import COLOR_BRIGHT, COLOR_STANDARD
...
class StoryScene(Scene):
    ...
    def setup(self):
        ...
        space_to_continue.set_position(
            (
                (DESIGN_WIDTH - space_to_continue.rect.width) // 2,
                DESIGN_HEIGHT - space_to_continue.rect.height - 50,
            ),
        )
