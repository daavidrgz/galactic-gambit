...
class TestLevel(Level):
    def __init__(self):
        ...
        self.test_enemy_0 = RangedEnemy1((124 * 32, 126 * 32))
        self.test_enemy_1 = RangedEnemy1((124 * 32, 127 * 32))
        self.test_enemy_2 = RangedEnemy1((124 * 32, 128 * 32))
        self.test_enemy_3 = RangedEnemy1((124 * 32, 129 * 32))
        self.test_enemy_4 = RangedEnemy1((125 * 32, 126 * 32))
        self.test_enemy_5 = RangedEnemy1((125 * 32, 127 * 32))
        self.test_enemy_6 = RangedEnemy1((125 * 32, 128 * 32))
        self.test_enemy_7 = RangedEnemy1((125 * 32, 129 * 32))
        self.test_enemy_8 = RangedEnemy1((123 * 32, 126 * 32))
        self.test_enemy_9 = RangedEnemy1((123 * 32, 127 * 32))
